...
public class FileReading {
    ...
    public void inputStream() {
        ...
        InputStream inputStreamWithClass = this.getClass().getResourceAsStream("/src/main/resources/notes/testfile.txt");
        assertNotNull(inputStreamWithClass);

        InputStream inputStreamWithClassLoader = this.getClass().getClassLoader().getResourceAsStream("src/main/resources/notes/testfile.txt");
    ...
    public void simpleBufferedReaderWithInputStream() throws IOException {
        ...
        try {
            is = this.getClass().getResourceAsStream("src/main/resources/notes/testfile.txt");
    ...
    public void simpleBufferedReaderWithFileReader() throws IOException {
        ...
        String file = "src/main/resources/notes/testfile.txt";
    ...
    public void readingSmallFileUsingFilesNIO() throws IOException{
        ...
        Path path = Paths.get("src/main/resources/notes/testfile.txt");
...
//        Path path = Paths.get(getClass().getClassLoader().getResource("testfile.txt").toURI());
    ...
    public void withScanner() {
        ...
        InputStream is = this.getClass().getResourceAsStream("/src/main/resources/notes/scannerTestFile.txt");
